...
<head>
    <meta charset="utf-8">
    <title>Best Education Platform</title>
                ...
                <div class="input-group">
                    <div class="input-group-prepend">
                        ...
                        <div class="dropdown-menu">
                            <a class="dropdown-item" href="cma1detail.jsp">CMA Foundation</a>
                            <a class="dropdown-item" href="cma2detail.jsp">CMA Inter</a>
                            <a class="dropdown-item" href="cma3detail.jsp">CMA Final</a>
                        </div>
                    </div>
                ...
                <div class="col-lg-8">
                    <div class="mb-5">
                        <div class="section-title position-relative mb-5">
                            ...
                            <h1 class="display-4">CMA Foundation Course</h1>
                        </div>
                   ...
                   <h2 class="mb-3">Related Courses</h2>
                    <div class="owl-carousel related-carousel position-relative" style="padding: 0 30px;">
                        <a class="courses-list-item position-relative d-block overflow-hidden mb-2" href="cma1detail.jsp">
                            <img class="img-fluid" src="img/courses-1.jpg" alt="">
                            <div class="courses-text">
                                <h4 class="text-center text-white px-3">CMA Foundation</h4>
                        ...
                        <a class="courses-list-item position-relative d-block overflow-hidden mb-2" href="cma2detail.jsp">
                            <img class="img-fluid" src="img/courses-2.jpg" alt="">
                            <div class="courses-text">
                                <h4 class="text-center text-white px-3">CMA Inter</h4>
                                <div class="border-top w-100 mt-3">
                                    <div class="d-flex justify-content-between p-4">
                                        <span class="text-white"><i class="fa fa-user mr-2"></i>Vinayak sir</span>
                                        <span class="text-white"><i class="fa fa-star mr-2"></i>4.5
                        ...
                        <a class="courses-list-item position-relative d-block overflow-hidden mb-2" href="cma3detail.jsp">
                            <img class="img-fluid" src="img/courses-3.jpg" alt="">
                            <div class="courses-text">
                                <h4 class="text-center text-white px-3">CMA Final</h4>
                                <div class="border-top w-100 mt-3">
                                    <div class="d-flex justify-content-between p-4">
                                        <span class="text-white"><i class="fa fa-user mr-2"></i>Vinayak sir</span>
                                        <span class="text-white"><i class="fa fa-star mr-2"></i>4.5
                ...
                <div class="col-lg-4 mt-5 mt-lg-0">
                    <div class="bg-primary mb-5 py-3">
                        ...
                        <div class="d-flex justify-content-between border-bottom px-4">
                            ...
                            <h6 class="text-white my-3">Vinayak sir</h6>
                        </div>
                        <div class="d-flex justify-content-between border-bottom px-4">
                        ...
                        <h5 class="text-white py-3 px-4 m-0">Course Price: ₹ 10000</h5>
                        <div class="py-3 px-4">
                            <a class="btn btn-block btn-secondary py-3 px-5" href="signin.jsp">Sign In</a>
                        </div>
                    </div>
                    ...
                    <div class="mb-5">
                        ...
                        <ul class="list-group list-group-flush">
                            <li class="list-group-item d-flex justify-content-between align-items-center px-0">
                                <a href="cma1detail.jsp" class="text-decoration-none h6 m-0">CMA Foundation</a>
                                <span class="badge badge-primary badge-pill">150</span>
                            </li>
                            <li class="list-group-item d-flex justify-content-between align-items-center px-0">
                                <a href="cma2detail.jsp" class="text-decoration-none h6 m-0">CMA Inter</a>
                                <span class="badge badge-primary badge-pill">131</span>
                            </li>
                            <li class="list-group-item d-flex justify-content-between align-items-center px-0">
                                <a href="cma3detail.jsp" class="text-decoration-none h6 m-0">CMA Final</a>
