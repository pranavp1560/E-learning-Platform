            ...
            <div class="row">
                ...
                <div class="col-lg-7">
                    <div class="section-title position-relative mb-4">
                        ...
                        <h1 class="display-4">We lead dreams to reality!</h1>
                    </div>
                    <p>Championing the Commerce education with a resolute mission and an expansive vision</p>
        ...
        <div class="container py-5">
            <div class="row">
                <div class="col-lg-7 mb-5 mb-lg-0">
                    ...
                    <div class="d-flex mb-3">
                        <div class="btn-icon bg-primary mr-4">
                            <i class="fa fa-2x fa-money text-white"></i>
                        </div>
                        <div class="mt-n1">
                        ...
                        <div class="container">
                          ...
                          <!---->  <div class="row">
                                <div class="col-md-6 d-flex align-items-stretch" data-aos="fade-up">
                                    <div class="card" style="background-image: url(img/.jpg);">
                                        <div class="card-body">
                                            <h5 class="card-title">
                                                <a href="">Our Vision</a>
                                            </h5>
                                            <p class="card-text">To provide Quality Education for a better future also provide Quality & Quest for Excellence</p>
                                            <!--<div class="read-more">
                                                <a href="#about"><i class="bi bi-arrow-right"></i> Read More</a>
                                            </div>-->
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6 d-flex align-items-stretch mt-4 mt-md-0" data-aos="fade-up" data-aos-delay="100">
                                    <div class="card" style="background-image: url(img/.jpg);">
                                        <div class="card-body">
                                            ...
                                            <p class="card-text">Innovate,Imbibe,Inculcate; where students enter to learn and leave as invinsible proffesionals</p>
                                            <!--<div class="read-more">
                                                <a href="#about"><i class="bi bi-arrow-right"></i> Read More</a>
                                            </div>-->
                                        </div>
                              ...
                              <!----  <div class="col-md-6 d-flex align-items-stretch mt-4" data-aos="fade-up" data-aos-delay="200">
                                    <div class="card" style="background-image: url(assets/img/values-3.jpg);">
                                        <div class="card-body">
                                            ...
                                            <p class="card-text">To build an independent business brand 1qlik is an online platform provided to everyone that will be generate income by investing a small amount.</p>
                                            <!-<div class="read-more">
                                                <a href="javascript:void(0);"><i class="bi bi-arrow-right"></i> Read More</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6 d-flex align-items-stretch mt-4" data-aos="fade-up" data-aos-delay="300">
                                    <div class="card" style="background-image: url(assets/img/values-4.jpg);">
                                        <div class="card-body">
                                            ...
                                            <p class="card-text">We want to change Traditional business styles and make Indian businesses smart and digital beyond the timeline same like a big fish.</p>
                                            <!-<div class="read-more">
                                                <a href="#about"><i class="bi bi-arrow-right"></i> Read More</a>
                                            </div>
                                        </div>
