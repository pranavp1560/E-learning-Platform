                ...
                <div class="input-group">
                    <div class="input-group-prepend">
                        ...
                        <div class="dropdown-menu">
                             <a class="dropdown-item" href="11th.jsp">11th Commerce </a>
                            <a class="dropdown-item" href="12th.jsp">12th Commerce</a>
                ...
                <div class="col-lg-8">
                    <div class="mb-5">
                        <div class="section-title position-relative mb-5">
                            ...
                            <h1 class="display-4">12th Commerce</h1>
                        </div>
                   ...
                   <h2 class="mb-3">Related Courses</h2>
                    <div class="owl-carousel related-carousel position-relative" style="padding: 0 30px;">
                      <a class="courses-list-item position-relative d-block overflow-hidden mb-2" href="11th.jsp">
                            <img class="img-fluid" src="img/courses-1.jpg" alt="">
                            <div class="courses-text">
                                <h4 class="text-center text-white px-3">11th Commerce</h4>
                        ...
                        <a class="courses-list-item position-relative d-block overflow-hidden mb-2" href="ca.jsp">
                            <img class="img-fluid" src="img/courses-1.jpg" alt="">
                            <div class="courses-text">
                        ...
                        <a class="courses-list-item position-relative d-block overflow-hidden mb-2" href="cma.jsp">
                        ...
                        <a class="courses-list-item position-relative d-block overflow-hidden mb-2" href="cs.jsp">
                    ...
                    <div class="mb-5">
                        ...
                        <ul class="list-group list-group-flush">
                            <li class="list-group-item d-flex justify-content-between align-items-center px-0">
                                <a href="ca.jsp" class="text-decoration-none h6 m-0">CA</a>
                                <span class="badge badge-primary badge-pill">150</span>
                            </li>
                            <li class="list-group-item d-flex justify-content-between align-items-center px-0">
                                <a href="cma.jsp" class="text-decoration-none h6 m-0">CMA</a>
                                <span class="badge badge-primary badge-pill">131</span>
                            </li>
                            <li class="list-group-item d-flex justify-content-between align-items-center px-0">
                                <a href="cs.jsp" class="text-decoration-none h6 m-0">CS</a>
