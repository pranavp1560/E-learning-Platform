...
<body>
   <div class="container">
        ...
        <form  action="${pageContext.request.contextPath}/AdmissionServlet" method="post">
            ...
            <div class="form-group">
                ...
                <input type="text" id="mothersName" name="mothersName" placeholder="Enter Mother's Name">
            </div>
            <div class="form-group">
                <label for="address">*Permanent Address:</label>
                <input type="text" id="address" name="address" placeholder="Enter Permanent Address">
            </div>
            ...
            <div class="form-group">
                ...
                <input type="tel" id="emergencyPhone" name="emergencyPhone" placeholder="Enter Emergency Number">
            </div>
            <div class="form-group">
