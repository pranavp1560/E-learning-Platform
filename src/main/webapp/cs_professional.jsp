                ...
                <div class="input-group">
                    <div class="input-group-prepend">
                        ...
                        <div class="dropdown-menu">
                            <a class="dropdown-item" href="cseet.jsp">CSEET</a>
                            <a class="dropdown-item" href="cs_executive.jsp">CS Executive</a>
                            <a class="dropdown-item" href="cs_professional.jsp">CS Professional</a>
                        </div>
                    </div>
                ...
                <div class="col-lg-8">
                    <div class="mb-5">
                        <div class="section-title position-relative mb-5">
                            ...
                            <h1 class="display-4">CS Professional</h1>
                        </div>
                   ...
                   <h2 class="mb-3">Related Courses</h2>
                    <div class="owl-carousel related-carousel position-relative" style="padding: 0 30px;">
                        <a class="courses-list-item position-relative d-block overflow-hidden mb-2" href="cseet.jsp">
                            <img class="img-fluid" src="img/courses-1.jpg" alt="">
                            <div class="courses-text">
                                <h4 class="text-center text-white px-3">CSEET</h4>
                        ...
                        <a class="courses-list-item position-relative d-block overflow-hidden mb-2" href="cs_executive.jsp">
                            <img class="img-fluid" src="img/courses-2.jpg" alt="">
                            <div class="courses-text">
                                <h4 class="text-center text-white px-3">CS Executive</h4>
                                <div class="border-top w-100 mt-3">
                                    <div class="d-flex justify-content-between p-4">
                                        <span class="text-white"><i class="fa fa-user mr-2"></i>Vinayak sir</span>
                                        <span class="text-white"><i class="fa fa-star mr-2"></i>4.5
                        ...
                        <a class="courses-list-item position-relative d-block overflow-hidden mb-2" href="cs_professional.jsp">
                            <img class="img-fluid" src="img/courses-3.jpg" alt="">
                            <div class="courses-text">
                                <h4 class="text-center text-white px-3">CS Professional</h4>
                                <div class="border-top w-100 mt-3">
                                    <div class="d-flex justify-content-between p-4">
                                        <span class="text-white"><i class="fa fa-user mr-2"></i>Vinayak sir</span>
                                        <span class="text-white"><i class="fa fa-star mr-2"></i>4.5
                    ...
                    <div class="mb-5">
                        ...
                        <ul class="list-group list-group-flush">
                            <li class="list-group-item d-flex justify-content-between align-items-center px-0">
                                <a href="cseet.jsp" class="text-decoration-none h6 m-0">CSEET</a>
                                <span class="badge badge-primary badge-pill">150</span>
                            </li>
                            <li class="list-group-item d-flex justify-content-between align-items-center px-0">
                                <a href="cs_executive.jsp" class="text-decoration-none h6 m-0">CS Executive</a>
                                <span class="badge badge-primary badge-pill">131</span>
                            </li>
                            <li class="list-group-item d-flex justify-content-between align-items-center px-0">
                                <a href="cs_professional.jsp" class="text-decoration-none h6 m-0">CS Professional</a>
